...
@section('title', 'Edit Member - Arifa Jaya POS')
    ...
    <div class="col-lg-8">
        <div class="data-card">
            <div class="data-card-header">
                <h5><i class="fas fa-edit me-2"></i>Edit Member: {{ $membership->name }}</h5>
            </div>
            <div class="data-card-body">
                <form action="{{ route('cashier.membership.update', $membership->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   class="form-control"
                                   value="{{ $membership->membership_code }}"
                                   disabled
                                   readonly>
                        </div>
                        <small class="text-muted">Kode member tidak dapat diubah</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Maks. 20 karakter, hanya huruf</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   id="phone"
                                   name="phone"
                                   value="{{ old('phone', $membership->phone) }}"
                                   maxlength="20"
                                   pattern="[0-9]+"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror"
                                      id="address"
                                      name="address"
                                      rows="3">{{ old('address', $membership->address) }}</textarea>
                            @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
